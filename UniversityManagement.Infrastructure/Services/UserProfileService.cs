    ...
    public async Task<List<UserProfileDto>> SearchUsersAsync(SearchUsersDto searchDto)
    {
        ...
        var users = await pagedQuery
            .Select(u => new UserProfileDto
            {
                ...
                LastLoginAt = u.UserProfile != null ? u.UserProfile.LastLoginAt : DateTime.MinValue,
                IsActive = u.IsActive,
                StudentId = u.Student != null ? u.Student.Id.ToString() : null,
                TeacherId = u.Teacher != null ? u.Teacher.Id.ToString() : null,
