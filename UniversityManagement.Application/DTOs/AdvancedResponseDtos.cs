...
public class DetailedStudentResponseDto
{
...
public class DetailedTeacherResponseDto
{
    public int Id { get; set; }
    public string FullName { get; set; }
    public int DepartmentId { get; set; }
...
public class DetailedCourseResponseDto
{
    public int Id { get; set; }
...
public class DetailedEnrollmentResponseDto
{
...
public class DetailedGradeResponseDto
{
    public int StudentId { get; set; }
    public int CourseId { get; set; }
